...
public class Controller {
    ...
    void  mouseClick(MouseEvent event) {
        ...
        if (selectedValue != null) {
            functionTextField.setText(selectedValue.getFunction().toString());
            sequenceTextArea.setText(selectedValue.getSequence().toString());// Assuming YourClass has a meaningful toString method
        } else {
